...
const Add_Teacher = () => {
  ...
  const handleAddTeacher = async (teacherData) => {
    setLoading(true);
    try {
      const result = await adminAuthService.createTeacher(teacherData);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Add New Teacher</h1>
          <p className="text-gray-600">Fill in the details to add a new teacher</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <form onSubmit={(e) => {
            e.preventDefault();
            handleAddTeacher({ full_name, email, password_hash, is_active, profile_image });
          }} className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`text-sm ${is_active ? 'text-green-600' : 'text-red-600'}`}>
                  {is_active ? 'Teacher will be active' : 'Teacher will be inactive'}
                </span>
              </div>
            </div>

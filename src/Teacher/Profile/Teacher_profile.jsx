          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-8">
            <div className="flex flex-col items-center">
              ...
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden bg-white border-4 border-white shadow-lg">
                {teacherData?.profile_image_url ? (
                  <img
                    src={`http://localhost:3500${teacherData.profile_image_url}`}
              ...
              {/* <h2 className="text-xl font-bold text-white mt-4">{teacherData?.full_name}</h2> */}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                  <p className="text-gray-800 font-medium">{teacherData?.full_name || 'N/A'}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                  <p className="text-gray-800 font-medium">{teacherData?.email || 'N/A'}</p>
                </div>
              </div>
